...
const loadPage = async (camera: string) => {
    ...
    const initPlayer = async () => {
        ...
        const showSnapshot = () => {
            fallbackImg.src =
                `/cameras-service/${camera}/snapshot.jpg?_t=${Date.now()}`;
        ...
        const getLiveStreamUrl = (forceRefresh = false) => {
            ...
            return `/cameras-service/${camera}/playlist.m3u8?_t=${timestamp}${refreshParam}`;
        };
...
interface SeeCameraProps {
    camera: string;
}

export default function Home(props: SeeCameraProps) {
    return (
        <Basic>
            <div style={{ maxWidth: "800px", margin: "20px auto" }}>
                ...
                >
                    ...
                    <a
                        href={`/camera/${props.camera}/snapshot`}
                        style={{
                            color: "#007bff",
                            textDecoration: "none",
                        }}
